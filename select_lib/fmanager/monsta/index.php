<?php 
//##############################################
// MONSTA FTP v1.4.4 by MONSTA APPS
//##############################################
//
...
// Leave this blank if you want the user to input data-transform=\"input-control\" their host address.
$ftpHost = $elib_ftp_server;
...
<input data-transform=\"input-control\" type="hidden" name="login" value="1">
<input data-transform=\"input-control\" type="hidden" name="openFolder" value="<?php echo $_GET["openFolder"]; ?>">

<?php if ($ftpHost == "") { ?>
<?php echo $lang_ftp_host; ?>:
<br><input data-transform=\"input-control\" type="text" name="ftp_host" value="<?php echo sanitizeStr($ftp_host); ?>" size="30" class="<?php if ($posted==1 && $ftp_host=="") echo "bgFormError"; ?>"> 
<?php echo $lang_port; ?>: <input data-transform=\"input-control\" type="text" name="ftp_port" value="<?php echo sanitizeStr($ftp_port) ?>" size="3" class="<?php if ($posted==1 && $ftp_port=="") echo "bgFormError"; ?>" tabindex="-1"> 
<p>
<?php } ?>

<?php echo $lang_username; ?>:
<br><input data-transform=\"input-control\" type="text" name="ftp_user" value="<?php echo sanitizeStr($ftp_user); ?>" class="<?php if ($posted==1 && $ftp_user=="") echo "bgFormError"; ?>">

<p><?php echo $lang_password; ?>:
<br><input data-transform=\"input-control\" type="password" name="ftp_pass" value="<?php echo sanitizeStr($ftp_pass); ?>" class="<?php if ($posted==1 && $ftp_pass=="") echo "bgFormError"; ?>" autocomplete="off">

<div class="floatLeft">
	<input data-transform=\"input-control\" type="submit" value="<?php echo $lang_btn_login; ?>" id="btnLogin">
</div>
...
<?php if ($ftpHost == "") { ?>
<p><input data-transform=\"input-control\" type="checkbox" name="ftp_pasv" value="1" <?php if ($ftp_pasv == 1) echo "checked"; ?> tabindex="-1"> <?php echo $lang_passive_mode; ?>
<p><input data-transform=\"input-control\" type="checkbox" name="ftp_ssl" value="1" <?php if ($ftp_ssl == 1) echo "checked"; ?> tabindex="-1"> <?php echo $lang_ftp_ssl; ?>
<?php }?>

<p><input data-transform=\"input-control\" type="checkbox" name="ip_check" value="1" <?php if ($ip_check == 1) echo "checked"; ?> tabindex="-1"> <?php echo $lang_ip_check; ?>
<p><input data-transform=\"input-control\" type="checkbox" name="interface" value="adv" <?php if ($interface == "adv" || $interface == "") echo "checked"; ?> tabindex="-1"> <?php echo $lang_adv_interface; ?>
<p><input data-transform=\"input-control\" type="checkbox" name="login_save" value="1" <?php if ($login_save == 1) echo "checked"; ?> tabindex="-1"> <?php echo $lang_save_login; ?>
...
function displayFiles() {
	...
	echo "<table class='dataTable display cell-border sortable' width=\"100%\" cellpadding=\"7\" cellspacing=\"0\" id=\"ftpTable\">";
	echo "<tr>";
		echo "<td width=\"16\" class=\"ftpTableHeadingNf\"><input data-transform=\"input-control\" type=\"checkbox\" id=\"checkboxSelector\" onClick=\"checkboxSelectAll()\"></td>";
...
function getFileListHtml($array,$image) {
	...
	foreach ($array AS $file) {
		...
		$html .= "<td>";
		$html .= "<input data-transform=\"input-control\" type=\"checkbox\" name=\"".$action."[]\" value=\"".rawurlencode($file_path)."\" onclick=\"checkFileChecked()\" ".$checked.">";
		$html .= "</td>";
...
<div id="ftpActionButtonsDiv">
	<input data-transform=\"input-control\" type="button" value="<?php echo $lang_btn_refresh; ?>" onClick="refreshListing()" class="<?php echo adjustButtonWidth($lang_btn_refresh); ?>"> 
	<input data-transform=\"input-control\" type="button" id="actionButtonCut" value="<?php echo $lang_btn_cut; ?>" onClick="actionFunctionCut('','');" disabled class="<?php echo adjustButtonWidth($lang_btn_cut); ?>"> 
	<input data-transform=\"input-control\" type="button" id="actionButtonCopy" value="<?php echo $lang_btn_copy; ?>" onClick="actionFunctionCopy('','');" disabled class="<?php echo adjustButtonWidth($lang_btn_copy); ?>"> 
	<input data-transform=\"input-control\" type="button" id="actionButtonPaste" value="<?php echo $lang_btn_paste; ?>" onClick="actionFunctionPaste('');" disabled class="<?php echo adjustButtonWidth($lang_btn_paste); ?>"> 
	<input data-transform=\"input-control\" type="button" id="actionButtonRename" value="<?php echo $lang_btn_rename; ?>" onClick="actionFunctionRename('','');" disabled class="<?php echo adjustButtonWidth($lang_btn_rename); ?>"> 
	<input data-transform=\"input-control\" type="button" id="actionButtonDelete" value="<?php echo $lang_btn_delete; ?>" onClick="actionFunctionDelete('','');" disabled class="<?php echo adjustButtonWidth($lang_btn_delete); ?>">
<?php if ($_SESSION["interface"] == "adv" && $_SESSION["win_lin"] == "lin") { ?>
	<input data-transform=\"input-control\" type="button" id="actionButtonChmod" value="<?php echo $lang_btn_chmod; ?>" onClick="actionFunctionChmod('','');" disabled class="<?php echo adjustButtonWidth($lang_btn_chmod); ?>">
<?php } ?>
<div class="floatRight">
	<input data-transform=\"input-control\" type="button" value="<?php echo $lang_btn_logout; ?>" onClick="actionFunctionLogout();" class="<?php echo adjustButtonWidth($lang_btn_logout); ?>">
</div>
</div>
<?php 
}
...
<table class='dataTable display cell-border sortable' width="100%" cellpadding="7" cellspacing="0" id="uploadProgressTable">
<tr>
...
<div id="footerDiv">
	...
	<div class="floatLeft10">
		<input data-transform=\"input-control\" type="button" value="<?php echo $lang_btn_new_folder; ?>" onClick="processForm('&ftpAction=newFolder')" class="<?php echo adjustButtonWidth($lang_btn_new_folder); ?>">
	</div>
	
	<div class="floatLeft10">
		<input data-transform=\"input-control\" type="button" value="<?php echo $lang_btn_new_file; ?>" onClick="processForm('&ftpAction=newFile')" class="<?php echo adjustButtonWidth($lang_btn_new_file); ?>">
	</div>
...
function renameFiles() {
	...
	if ($_POST["processAction"] == 1) {
		...
		foreach($folderArray AS $folder) {
			...
			echo "<input data-transform=\"input-control\" type=\"text\" name=\"file".$i."\" class=\"input data-transform=\"input-control\"Rename\" value=\"".quotesReplace($folder,"d")."\" ".$onKeyPress."><br>";
		...
		foreach($fileArray AS $file) {
			...
			echo "<input data-transform=\"input-control\" type=\"text\" name=\"file".$i."\" class=\"input data-transform=\"input-control\"Rename\" value=\"".quotesReplace($file,"d")."\" ".$onKeyPress."><br>";
...
<?php if ($type == "manual") { ?>
<input data-transform=\"input-control\" type="text" size="4" name="chmodNum" id="chmodNum" value="<?php echo $chmod; ?>" onkeypress="if (event.keyCode==13){ processForm('<?php echo $vars; ?>'); activateActionButtons(0,0); return false;}">
<?php }else{ ?>
<?php 
	if ($type == "owner")
		$n = 100;
	...
	$n_e = $n * 1;
 ?>
<div class="checkboxChmod"><input data-transform=\"input-control\" type="checkbox" id="<?php echo $type; ?>_r" value="1" <?php if (substr($chmod,0,1) == "r") echo "checked"; ?> onclick="updateChmodNum(this.id,<?php echo $n_r; ?>)"> <?php echo $lang_chmod_read; ?></div>
<div class="checkboxChmod"><input data-transform=\"input-control\" type="checkbox" id="<?php echo $type; ?>_w" value="1" <?php if (substr($chmod,1,1) == "w") echo "checked"; ?> onclick="updateChmodNum(this.id,<?php echo $n_w; ?>)"> <?php echo $lang_chmod_write; ?></div>
<div class="checkboxChmod"><input data-transform=\"input-control\" type="checkbox" id="<?php echo $type; ?>_e" value="1" <?php if (substr($chmod,2,1) == "x") echo "checked"; ?> onclick="updateChmodNum(this.id,<?php echo $n_e; ?>)"> <?php echo $lang_chmod_exe; ?></div>
<?php } ?>
</fieldset>
<?php 
}
...
function displayEditFileForm($file,$content) {
	...
	echo "<input data-transform=\"input-control\" type=\"hidden\" name=\"file\" value=\"".sanitizeStr($file)."\">";
	echo "<textarea name=\"editContent\" id=\"editContent\" style=\"height: ".$editorHeight."px;\">".sanitizeStr($content)."</textarea>";
	
	// Save button
	echo "<input data-transform=\"input-control\" type=\"button\" value=\"".$lang_btn_save."\" class=\"popUpBtn\" onClick=\"submitToIframe('&ftpAction=editProcess');\"> ";
	
	// Close button
	echo "<input data-transform=\"input-control\" type=\"button\" value=\"".$lang_btn_close."\" class=\"popUpBtn\" onClick=\"processForm('&ftpAction=openFolder')\"> ";
...
function newFile() {
	...
	if ($file_name == "") { 
		...
		echo "<input data-transform=\"input-control\" type=\"text\" name=\"newFile\" id=\"newFile\" placeholder=\"".$lang_new_file_name."\" onkeypress=\"if (event.keyCode==13){ processForm('".$vars."'); return false;}\">";
...
function newFolder() {
	...
	if ($folder == "") { 
		...
		echo "<input data-transform=\"input-control\" type=\"text\" name=\"newFolder\" id=\"newFolder\" placeholder=\"".$lang_new_folder_name."\" onkeypress=\"if (event.keyCode==13){ processForm('".$vars."'); return false;}\">";
...
function uploadFile() {
	...
	if ($file_name) {
		...
		if (file_put_contents($fp1,file_get_contents('php://input data-transform=\"input-control\"'))) {
...
function displayPopupClose($isError,$vars,$btnCancel) {
	...
	// OK button
	if ($vars != "")
		echo "<input data-transform=\"input-control\" type=\"button\" class=\"popUpBtn\" value=\"".$lang_btn_ok."\" onClick=\"processForm('".$vars."'); activateActionButtons(0,0);\"> ";
	
	// Cancel button
	if ($btnCancel == 1)
		echo "<input data-transform=\"input-control\" type=\"button\" class=\"popUpBtn\" value=\"".$lang_btn_cancel."\" onClick=\"processForm('&ftpAction=openFolder');\"> ";
		...
		if ($dh = opendir($dir)) {
			...
			if ($skin_found == 0) {
				...
				if ($i > 1) {
					...
					echo "<input data-transform=\"input-control\" type=\"hidden\" name=\"skin\" value=\"".$file_name."\">";
				}
			}
		...
		if ($dh = opendir($dir)) {
			...
			if ($lang_found == 0) {
				...
				if ($i > 1) {
					...
					echo "<input data-transform=\"input-control\" type=\"hidden\" name=\"lang\" value=\"".$file_name."\">";
				}
			}
...
function sessionExpired($message) {
	...
	echo "<p><input data-transform=\"input-control\" type=\"button\" id=\"btnLogin\" value=\"".$lang_btn_login."\" onClick=\"document.location.href='?openFolder=".$_POST["openFolder"]."'\">";
...
function adjustButtonWidth($str) {
	...
	if (strlen(utf8_decode($str)) > 12)
		return "input data-transform=\"input-control\"ButtonNf";
	else
		return "input data-transform=\"input-control\"Button";
}
