<?php require_once( '../../../stuff/config.php'); permission( 'admin', false); ?>

<script src = '../../../stuff/style/jquery-ui-1.8.13.custom.min.js'> </script>
<script src = '../../../stuff/style/jquery.multi-open-accordion-1.5.3.js'> </script>
...
<div style="background-color:white; position: absolute; display:none; height:100%;width:95%; top: 0px;" class = 'multiOpenAccordion loadwait'>
...
<div style="background-color:white; position: absolute; height:100%;width:5%; top: 0px; right: 0px;" class = "loadwait">
	<h5><?php echo _("ВСЁ"); ?></h5>
	<button class = 'danger' onclick = "toggle_all('.multiOpenAccordion', '#tgl_all')" id = 'tgl_all'> <?php echo _("Вид"); ?> </button>
	<h5><?php echo _("Ученики"); ?></h5>
	<button class = 'danger' onclick = "toggle_all('.stu', '#tgl_s')" id = 'tgl_s'> <?php echo _("Вид"); ?> </button>
	<h5><?php echo _("Инф"); ?></h5>
	<button class = 'danger' onclick = "toggle_all('.sinf', '#tgl_b')" id = 'tgl_b'> <?php echo _("Вид"); ?> </button>
	<h5>
        <?php echo _("Скрыть"); ?>
		<br>
        <?php echo _("Панель"); ?>
	</h5>
	<button class = 'danger' onclick = "$(this).parent().toggle()">  OK </button>
</div>
...
<script>
	...
	loading("begin");
	steps("<?php echo _("Формировка"); ?>");
	$('.multiOpenAccordion').multiOpenAccordion();
	steps("Подготовка");
	$('.multiOpenAccordion').multiOpenAccordion({active:"none"});
