<?php
	...
	if($_POST['sub']){
		...
		// finding book name and owner, date evaluation
		...
		update_db($stu, $s1, $s2, $today, $con);
		put_in_history($con, $stu, "Вы взяли с библиотеки книгу с СН : $s1 / $s2 и названием = $book_name", "Книга взята");
